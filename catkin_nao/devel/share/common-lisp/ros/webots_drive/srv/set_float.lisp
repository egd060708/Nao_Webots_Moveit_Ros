...
(cl:defmethod cl:initialize-instance :after ((m <set_float-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_float-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<set_float-request> is deprecated: use webots_drive-srv:set_float-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <set_float-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_float-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<set_float-response> is deprecated: use webots_drive-srv:set_float-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_float-response>)))
  ...
  "webots_drive/set_floatResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_float-response)))
  "Returns string type for a service object of type 'set_float-response"
  "webots_drive/set_floatResponse")
