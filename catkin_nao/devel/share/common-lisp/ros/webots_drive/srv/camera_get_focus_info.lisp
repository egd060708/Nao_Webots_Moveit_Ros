...
(cl:defmethod cl:initialize-instance :after ((m <camera_get_focus_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera_get_focus_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<camera_get_focus_info-request> is deprecated: use webots_drive-srv:camera_get_focus_info-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<camera_get_focus_info-request>)))
  ...
  "webots_drive/camera_get_focus_infoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'camera_get_focus_info-request)))
  "Returns string type for a service object of type 'camera_get_focus_info-request"
  "webots_drive/camera_get_focus_infoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <camera_get_focus_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera_get_focus_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<camera_get_focus_info-response> is deprecated: use webots_drive-srv:camera_get_focus_info-response instead.")))

(cl:ensure-generic-function 'focalLength-val :lambda-list '(m))
(cl:defmethod focalLength-val ((m <camera_get_focus_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:focalLength-val is deprecated.  Use webots_drive-srv:focalLength instead.")
  (focalLength m))
...
(cl:defmethod focalDistance-val ((m <camera_get_focus_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:focalDistance-val is deprecated.  Use webots_drive-srv:focalDistance instead.")
  (focalDistance m))
...
(cl:defmethod maxFocalDistance-val ((m <camera_get_focus_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:maxFocalDistance-val is deprecated.  Use webots_drive-srv:maxFocalDistance instead.")
  (maxFocalDistance m))
...
(cl:defmethod minFocalDistance-val ((m <camera_get_focus_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:minFocalDistance-val is deprecated.  Use webots_drive-srv:minFocalDistance instead.")
  (minFocalDistance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<camera_get_focus_info-response>)))
  ...
  "webots_drive/camera_get_focus_infoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'camera_get_focus_info-response)))
  "Returns string type for a service object of type 'camera_get_focus_info-response"
  "webots_drive/camera_get_focus_infoResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'camera_get_focus_info)))
  ...
  "webots_drive/camera_get_focus_info")