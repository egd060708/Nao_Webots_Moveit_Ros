...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_frequency_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_frequency_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<lidar_get_frequency_info-request> is deprecated: use webots_drive-srv:lidar_get_frequency_info-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_frequency_info-request>)))
  ...
  "webots_drive/lidar_get_frequency_infoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_frequency_info-request)))
  "Returns string type for a service object of type 'lidar_get_frequency_info-request"
  "webots_drive/lidar_get_frequency_infoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_frequency_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_frequency_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<lidar_get_frequency_info-response> is deprecated: use webots_drive-srv:lidar_get_frequency_info-response instead.")))

(cl:ensure-generic-function 'frequency-val :lambda-list '(m))
(cl:defmethod frequency-val ((m <lidar_get_frequency_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:frequency-val is deprecated.  Use webots_drive-srv:frequency instead.")
  (frequency m))
...
(cl:defmethod minFrequency-val ((m <lidar_get_frequency_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:minFrequency-val is deprecated.  Use webots_drive-srv:minFrequency instead.")
  (minFrequency m))
...
(cl:defmethod maxFrequency-val ((m <lidar_get_frequency_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:maxFrequency-val is deprecated.  Use webots_drive-srv:maxFrequency instead.")
  (maxFrequency m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_frequency_info-response>)))
  ...
  "webots_drive/lidar_get_frequency_infoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_frequency_info-response)))
  "Returns string type for a service object of type 'lidar_get_frequency_info-response"
  "webots_drive/lidar_get_frequency_infoResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_frequency_info)))
  ...
  "webots_drive/lidar_get_frequency_info")