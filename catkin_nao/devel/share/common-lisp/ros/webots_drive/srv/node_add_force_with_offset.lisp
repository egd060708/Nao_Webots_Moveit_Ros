...
(cl:defmethod cl:initialize-instance :after ((m <node_add_force_with_offset-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_add_force_with_offset-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<node_add_force_with_offset-request> is deprecated: use webots_drive-srv:node_add_force_with_offset-request instead.")))
...
(cl:defmethod force-val ((m <node_add_force_with_offset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:force-val is deprecated.  Use webots_drive-srv:force instead.")
  (force m))

(cl:ensure-generic-function 'offset-val :lambda-list '(m))
(cl:defmethod offset-val ((m <node_add_force_with_offset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:offset-val is deprecated.  Use webots_drive-srv:offset instead.")
  (offset m))

(cl:ensure-generic-function 'relative-val :lambda-list '(m))
(cl:defmethod relative-val ((m <node_add_force_with_offset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:relative-val is deprecated.  Use webots_drive-srv:relative instead.")
  (relative m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_add_force_with_offset-request>)))
  ...
  "webots_drive/node_add_force_with_offsetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_add_force_with_offset-request)))
  "Returns string type for a service object of type 'node_add_force_with_offset-request"
  "webots_drive/node_add_force_with_offsetRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <node_add_force_with_offset-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_add_force_with_offset-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<node_add_force_with_offset-response> is deprecated: use webots_drive-srv:node_add_force_with_offset-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_add_force_with_offset-response>)))
  ...
  "webots_drive/node_add_force_with_offsetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_add_force_with_offset-response)))
  "Returns string type for a service object of type 'node_add_force_with_offset-response"
  "webots_drive/node_add_force_with_offsetResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_add_force_with_offset)))
  ...
  "webots_drive/node_add_force_with_offset")