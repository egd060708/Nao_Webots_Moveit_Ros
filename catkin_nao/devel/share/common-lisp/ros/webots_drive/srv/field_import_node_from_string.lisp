...
(cl:defmethod cl:initialize-instance :after ((m <field_import_node_from_string-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_import_node_from_string-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<field_import_node_from_string-request> is deprecated: use webots_drive-srv:field_import_node_from_string-request instead.")))
...
(cl:defmethod position-val ((m <field_import_node_from_string-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:position-val is deprecated.  Use webots_drive-srv:position instead.")
  (position m))
...
(cl:defmethod nodeString-val ((m <field_import_node_from_string-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:nodeString-val is deprecated.  Use webots_drive-srv:nodeString instead.")
  (nodeString m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<field_import_node_from_string-request>)))
  ...
  "webots_drive/field_import_node_from_stringRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'field_import_node_from_string-request)))
  "Returns string type for a service object of type 'field_import_node_from_string-request"
  "webots_drive/field_import_node_from_stringRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <field_import_node_from_string-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_import_node_from_string-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<field_import_node_from_string-response> is deprecated: use webots_drive-srv:field_import_node_from_string-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<field_import_node_from_string-response>)))
  ...
  "webots_drive/field_import_node_from_stringResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'field_import_node_from_string-response)))
  "Returns string type for a service object of type 'field_import_node_from_string-response"
  "webots_drive/field_import_node_from_stringResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'field_import_node_from_string)))
  ...
  "webots_drive/field_import_node_from_string")