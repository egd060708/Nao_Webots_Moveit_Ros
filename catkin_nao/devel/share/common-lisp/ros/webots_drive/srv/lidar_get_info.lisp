...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<lidar_get_info-request> is deprecated: use webots_drive-srv:lidar_get_info-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_info-request>)))
  ...
  "webots_drive/lidar_get_infoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_info-request)))
  "Returns string type for a service object of type 'lidar_get_info-request"
  "webots_drive/lidar_get_infoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-srv:<lidar_get_info-response> is deprecated: use webots_drive-srv:lidar_get_info-response instead.")))
...
(cl:defmethod horizontalResolution-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:horizontalResolution-val is deprecated.  Use webots_drive-srv:horizontalResolution instead.")
...
(cl:defmethod numberOfLayers-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:numberOfLayers-val is deprecated.  Use webots_drive-srv:numberOfLayers instead.")
  (numberOfLayers m))
...
(cl:defmethod verticalFov-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:verticalFov-val is deprecated.  Use webots_drive-srv:verticalFov instead.")
  (verticalFov m))

(cl:ensure-generic-function 'minRange-val :lambda-list '(m))
(cl:defmethod minRange-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:minRange-val is deprecated.  Use webots_drive-srv:minRange instead.")
  (minRange m))

(cl:ensure-generic-function 'maxRange-val :lambda-list '(m))
(cl:defmethod maxRange-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-srv:maxRange-val is deprecated.  Use webots_drive-srv:maxRange instead.")
  (maxRange m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_info-response>)))
  ...
  "webots_drive/lidar_get_infoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_info-response)))
  "Returns string type for a service object of type 'lidar_get_info-response"
  "webots_drive/lidar_get_infoResponse")
