...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-msg:<Float64Stamped> is deprecated: use webots_drive-msg:Float64Stamped instead.")))
...
(cl:defmethod data-val ((m <Float64Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-msg:data-val is deprecated.  Use webots_drive-msg:data instead.")
  (data m))
