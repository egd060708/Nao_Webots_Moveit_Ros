...
(cl:defmethod cl:initialize-instance :after ((m <Int32Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int32Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-msg:<Int32Stamped> is deprecated: use webots_drive-msg:Int32Stamped instead.")))
