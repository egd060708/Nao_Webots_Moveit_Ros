...
(cl:defmethod cl:initialize-instance :after ((m <ContactPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ContactPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-msg:<ContactPoint> is deprecated: use webots_drive-msg:ContactPoint instead.")))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <ContactPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-msg:point-val is deprecated.  Use webots_drive-msg:point instead.")
  (point m))

(cl:ensure-generic-function 'node_id-val :lambda-list '(m))
(cl:defmethod node_id-val ((m <ContactPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-msg:node_id-val is deprecated.  Use webots_drive-msg:node_id instead.")
  (node_id m))
