...
(cl:defmethod cl:initialize-instance :after ((m <RadarTarget>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RadarTarget)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_drive-msg:<RadarTarget> is deprecated: use webots_drive-msg:RadarTarget instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RadarTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-msg:header-val is deprecated.  Use webots_drive-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <RadarTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-msg:distance-val is deprecated.  Use webots_drive-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'receivedPower-val :lambda-list '(m))
(cl:defmethod receivedPower-val ((m <RadarTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-msg:receivedPower-val is deprecated.  Use webots_drive-msg:receivedPower instead.")
  (receivedPower m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <RadarTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-msg:speed-val is deprecated.  Use webots_drive-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'azimuth-val :lambda-list '(m))
(cl:defmethod azimuth-val ((m <RadarTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_drive-msg:azimuth-val is deprecated.  Use webots_drive-msg:azimuth instead.")
  (azimuth m))
