...
class lidar_get_frequency_infoRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/lidar_get_frequency_infoRequest';
  }
...
class lidar_get_frequency_infoResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/lidar_get_frequency_infoResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/lidar_get_frequency_info'; }
};
