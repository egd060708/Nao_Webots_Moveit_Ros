...
class node_add_force_or_torqueRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/node_add_force_or_torqueRequest';
  }
...
class node_add_force_or_torqueResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/node_add_force_or_torqueResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/node_add_force_or_torque'; }
};
