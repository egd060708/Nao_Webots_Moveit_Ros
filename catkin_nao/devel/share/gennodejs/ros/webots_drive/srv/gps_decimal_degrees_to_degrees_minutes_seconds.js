...
class gps_decimal_degrees_to_degrees_minutes_secondsRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/gps_decimal_degrees_to_degrees_minutes_secondsRequest';
  }
...
class gps_decimal_degrees_to_degrees_minutes_secondsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/gps_decimal_degrees_to_degrees_minutes_secondsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/gps_decimal_degrees_to_degrees_minutes_seconds'; }
};
