...
class field_disable_sf_trackingRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/field_disable_sf_trackingRequest';
  }
...
class field_disable_sf_trackingResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/field_disable_sf_trackingResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/field_disable_sf_tracking'; }
};
