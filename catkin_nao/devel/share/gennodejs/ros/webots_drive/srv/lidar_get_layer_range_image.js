...
class lidar_get_layer_range_imageRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/lidar_get_layer_range_imageRequest';
  }
...
class lidar_get_layer_range_imageResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/lidar_get_layer_range_imageResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/lidar_get_layer_range_image'; }
};
