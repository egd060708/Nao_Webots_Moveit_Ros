...
class node_disable_contact_points_trackingRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/node_disable_contact_points_trackingRequest';
  }
...
class node_disable_contact_points_trackingResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/node_disable_contact_points_trackingResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/node_disable_contact_points_tracking'; }
};
