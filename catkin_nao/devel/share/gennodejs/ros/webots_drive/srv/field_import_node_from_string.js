...
class field_import_node_from_stringRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/field_import_node_from_stringRequest';
  }
...
class field_import_node_from_stringResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/field_import_node_from_stringResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/field_import_node_from_string'; }
};
