...
class supervisor_movie_start_recordingRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/supervisor_movie_start_recordingRequest';
  }
...
class supervisor_movie_start_recordingResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/supervisor_movie_start_recordingResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/supervisor_movie_start_recording'; }
};
