...
class node_get_static_balanceRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/node_get_static_balanceRequest';
  }
...
class node_get_static_balanceResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/node_get_static_balanceResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/node_get_static_balance'; }
};
