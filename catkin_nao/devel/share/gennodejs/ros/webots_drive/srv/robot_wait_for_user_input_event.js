...
class robot_wait_for_user_input_eventRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/robot_wait_for_user_input_eventRequest';
  }
...
class robot_wait_for_user_input_eventResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/robot_wait_for_user_input_eventResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/robot_wait_for_user_input_event'; }
};
