...
class skin_set_bone_positionRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/skin_set_bone_positionRequest';
  }
...
class skin_set_bone_positionResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/skin_set_bone_positionResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/skin_set_bone_position'; }
};
