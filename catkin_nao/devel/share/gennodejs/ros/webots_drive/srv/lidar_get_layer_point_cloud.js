...
class lidar_get_layer_point_cloudRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/lidar_get_layer_point_cloudRequest';
  }
...
class lidar_get_layer_point_cloudResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/lidar_get_layer_point_cloudResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/lidar_get_layer_point_cloud'; }
};
