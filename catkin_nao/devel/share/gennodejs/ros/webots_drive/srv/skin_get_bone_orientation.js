...
class skin_get_bone_orientationRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/skin_get_bone_orientationRequest';
  }
...
class skin_get_bone_orientationResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/skin_get_bone_orientationResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/skin_get_bone_orientation'; }
};
