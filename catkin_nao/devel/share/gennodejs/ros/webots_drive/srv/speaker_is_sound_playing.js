...
class speaker_is_sound_playingRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/speaker_is_sound_playingRequest';
  }
...
class speaker_is_sound_playingResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/speaker_is_sound_playingResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/speaker_is_sound_playing'; }
};
