...
class supervisor_virtual_reality_headset_get_orientationRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/supervisor_virtual_reality_headset_get_orientationRequest';
  }
...
class supervisor_virtual_reality_headset_get_orientationResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/supervisor_virtual_reality_headset_get_orientationResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/supervisor_virtual_reality_headset_get_orientation'; }
};
