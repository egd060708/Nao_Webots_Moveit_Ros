...
class supervisor_get_from_stringRequest {
  ...
  static datatype() {
    ...
    return 'webots_drive/supervisor_get_from_stringRequest';
  }
...
class supervisor_get_from_stringResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_drive/supervisor_get_from_stringResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_drive/supervisor_get_from_string'; }
};
