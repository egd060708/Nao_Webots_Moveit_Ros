...
"""autogenerated by genpy from webots_drive/node_get_idRequest.msg. Do not edit."""
import codecs
import sys
...
class node_get_idRequest(genpy.Message):
  ...
  _type = "webots_drive/node_get_idRequest"
...
def _get_struct_Q():
    ...
    return _struct_Q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from webots_drive/node_get_idResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class node_get_idResponse(genpy.Message):
  ...
  _type = "webots_drive/node_get_idResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 id
...
class node_get_id(object):
  _type          = 'webots_drive/node_get_id'
