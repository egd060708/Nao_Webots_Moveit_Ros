...
"""autogenerated by genpy from webots_drive/field_get_rotationRequest.msg. Do not edit."""
import codecs
import sys
...
class field_get_rotationRequest(genpy.Message):
  ...
  _type = "webots_drive/field_get_rotationRequest"
...
def _get_struct_Qi():
    ...
    return _struct_Qi
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from webots_drive/field_get_rotationResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class field_get_rotationResponse(genpy.Message):
  ...
  _type = "webots_drive/field_get_rotationResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class field_get_rotation(object):
  _type          = 'webots_drive/field_get_rotation'
